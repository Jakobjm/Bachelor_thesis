...
# Preprocess etc.:
```{r}
religion_data <- read_csv("clean_atheismvsreligion_6months.csv")
...
```{r}
religion_data_EC <- read_csv("religionvsatheist2yrs_allcollumns.csv") 
...
religion_test_predictions$anti <- as.numeric(religion_test_predictions$anti)
religion_test_predictions$pro <- as.numeric(religion_test_predictions$pro)

religion_test_predictions <-  religion_test_predictions %>% 
...
ggplot(religion_test_predictions, aes(x=leaning_comb))+
	geom_density()
...
```{r}
religion_test_predictions_to_nodes <- religion_test_predictions %>%
